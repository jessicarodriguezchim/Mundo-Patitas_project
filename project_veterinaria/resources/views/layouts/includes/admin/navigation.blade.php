<nav class="fixed top-0 z-50 w-full bg-white border-b border-pastel-aqua/30 shadow-soft">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/" class="flex ms-2 md:me-24">
          <img src="{{ asset('images/logo.png') }}" class="h-8 me-3" alt="Mundo Patitas" />
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="border-t border-pastel-aqua/20"></div>
